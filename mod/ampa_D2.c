...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 8;
 	...
 	ivoc_help("help ?1 AMPA_D2 C:/Users/finkt/OneDrive - Gonzaga University/Documents/research/bazhenov_sleep_model/network_model/v6_updated/mod/ampa_D2.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "ampa_D2.mod";
...
{
 { error =  release();
 if(error){fprintf(stderr,"at line 72 in file ampa_D2.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "ampa_D2.mod";
static const char* nmodl_file_text = 
  "TITLE ampa_D2.mod\n"
  "\n"
  "COMMENT\n"
