...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 4;
 	...
 	ivoc_help("help ?1 GABA_A C:/Users/finkt/OneDrive - Gonzaga University/Documents/research/bazhenov_sleep_model/network_model/v6_updated/mod/gaba_A.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "gaba_A.mod";
...
{
 { error =  release();
 if(error){fprintf(stderr,"at line 63 in file gaba_A.mod:\n	:g = (Ron + Roff)*1(umho)\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "gaba_A.mod";
static const char* nmodl_file_text = 
  "TITLE gaba_A.mod\n"
  "\n"
  "COMMENT\n"
  ...
  "	Alpha  = 10.5  (/ms mM):forward (binding) rate (Krishnan currents.h line 632)\n"
  "	Beta   = 0.166 (/ms):backward (dissociation) rate (Krishnan currents.h line 632)\n"
