...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 kca C:/Users/finkt/OneDrive - Gonzaga University/Documents/research/bazhenov_sleep_model/network_model/v5/mod/kca.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "kca.mod";
...
static const char* nmodl_file_text = 
  ...
  "        gkca = gkcabar*m\n"
  "		ik = 2.952882641412121*gkca*(v - ek) :Krishnan currents.h line 402 prescribes 2.3^((36-23)/10)\n"
  "}\n"
  " \n"
  " \n"
  "INITIAL {\n"
