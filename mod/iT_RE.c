...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 it_re C:/Users/finkt/OneDrive - Gonzaga University/Documents/research/bazhenov_sleep_model/network_model/v5/mod/iT_RE.mod\n");
...
static int _reset;
static char *modelname = "Low threshold calcium current for RE cells";
...
#if NMODL_TEXT
static const char* nmodl_filename = "iT_RE.mod";
static const char* nmodl_file_text = 
  ...
  "PARAMETER {\n"
  "	v		(mV)\n"
  ":	celsius	= 36	(degC) CF: commenting out all references to celsius, because I don't want any possibility of NEURON somehow using a value other than 36 degrees\n"
  ":	eca	= 120	(mV)\n"
  "	gcabar	= .0023	(mho/cm2) :from Bazhenov C++ code (line 1501)\n"
  "	cai	= 2.4e-4 (mM)		: adjusted for eca=120 mV\n"
  "	cao	= 2	(mM)\n"
  "	:qm	= 5.0  : from Bazhenov C++ code (line 112)\n"
  "	:qh 	= 3.0  : from Bazhenov C++ code (line 113)\n"
  "}\n"
  "\n"
  "STATE {\n"
  "	m h\n"
  ...
  ":\n"
  "	phi_m = 6.898648307306074 :qm ^ ((celsius-24)/10)\n"
