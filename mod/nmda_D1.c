...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 NMDA_D1 C:/Users/finkt/OneDrive - Gonzaga University/Documents/research/bazhenov_sleep_model/network_model/v6_updated/mod/nmda_D1.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "nmda_D1.mod";
...
{
 { error =  release();
 if(error){fprintf(stderr,"at line 64 in file nmda_D1.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "nmda_D1.mod";
static const char* nmodl_file_text = 
  "TITLE nmda_D1.mod\n"
  "\n"
  "COMMENT\n"
  ...
  "	fn = 1/(1+exp(-(v + 25 (mV))/12.5 (mV))) :see \"Synaptic Currents\" section of Bazhenov 2002 (also in Krishnan's currents.cpp)\n"
  "	i = g*fn*(v - Erev)\n"
  "}\n"
  "\n"
  "DERIVATIVE release {\n"
