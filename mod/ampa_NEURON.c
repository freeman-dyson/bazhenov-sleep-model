...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 4;
 	...
 	ivoc_help("help ?1 AMPA_NEURON C:/Users/finkt/OneDrive - Gonzaga University/Documents/research/bazhenov_sleep_model/network_model/v5/mod/ampa_NEURON.mod\n");
...
{
 { error =  release();
 if(error){fprintf(stderr,"at line 53 in file ampa_NEURON.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "ampa_NEURON.mod";
static const char* nmodl_file_text = 
  "TITLE ampa.mod\n"
  "\n"
  "COMMENT\n"
